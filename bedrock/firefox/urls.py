...
urlpatterns = (
    ...
    # Temporary mock template
    page("firefox/features/new/article", "firefox/features/new/article.html", ftl_files=["firefox/features/shared"]),
    # page("firefox/features", "firefox/features/index.html", ftl_files=["firefox/features/shared", "firefox/features/index"]),
    path("firefox/features/", views.FeaturesIndexView.as_view(), name="firefox.features.index"),
    page("firefox/features/customize/", "firefox/features/new/customize.html", ftl_files=["firefox/features/shared"]),
    page("firefox/features/add-ons/", "firefox/features/new/add-ons.html", ftl_files=["firefox/features/shared"]),
    page("firefox/features/pinned-tabs/", "firefox/features/new/pinned-tabs.html", ftl_files=["firefox/features/shared"]),
    page("firefox/features/eyedropper/", "firefox/features/new/eyedropper.html", ftl_files=["firefox/features/shared"]),
    page("firefox/features/pdf-editor/", "firefox/features/new/pdf-editor.html", ftl_files=["firefox/features/shared"]),
    ...
    path("firefox/features/bookmarks/", views.FeaturesBookmarksView.as_view(), name="firefox.features.bookmarks"),
    # page("firefox/features/fast", "firefox/features/fast.html", ftl_files=["firefox/features/shared", "firefox/features/fast"]),
    path("firefox/features/fast/", views.FeaturesFastView.as_view(), name="firefox.features.fast"),
    page(
        "firefox/features/block-fingerprinting/",
        "firefox/features/new/fingerprinting.html",
    ...
    # ),
    path("firefox/features/password-manager/", views.FeaturesPasswordManagerView.as_view(), name="firefox.features.password-manager"),
    page(
        "firefox/features/private/",
        "firefox/features/new/private.html",
        ftl_files=["firefox/features/shared", "firefox/features/private"],
    ),
    # page(
    ...
    # ),
    path("firefox/features/private-browsing/", views.FeaturesPrivateBrowsingView.as_view(), name="firefox.features.private-browsing"),
    ...
    path("firefox/features/sync/", views.FeaturesSyncView.as_view(), name="firefox.features.sync"),
